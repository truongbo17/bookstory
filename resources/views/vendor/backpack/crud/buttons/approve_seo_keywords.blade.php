<a
    ...
    data-route="{{ url($crud->route.'/approve_seo_keywords') }}"
    data-button-type="patch"
    class="btn btn-success" data-style="zoom-in"><span
        class="ladda-label"><i class="lab la-accessible-icon"></i> Publish all {{ $crud->entity_name }}</span></a>
...
<script>
    function updateEntry(button) {
        ...
        swal({
            title: "All seo keywords with full information will be published !!!",
            icon: "info",
            buttons: ["Cancel", "Yes"],
            dangerMode: true,
        }).then((value) => {

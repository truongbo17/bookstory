...
<div id="sidebarUserMobile" class="hidden fixed inset-0 flex z-40 md:hidden" role="dialog" aria-modal="true">
    <div class="fixed inset-0 bg-gray-600 bg-opacity-75" aria-hidden="true"></div>
    <div class="relative flex-1 flex flex-col max-w-xs w-full bg-indigo-700">
        <div class="absolute top-0 right-0 -mr-12 pt-2">
            <button id="closeSidebarUserMobile" type="button"
...
<script>
    ...
    const closeSidebarUserMobile = document.getElementById('closeSidebarUserMobile');

    closeSidebarUserMobile.addEventListener('click', function () {
